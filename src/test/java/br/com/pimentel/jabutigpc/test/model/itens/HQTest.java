...
public class HQTest {
	...
	public static void setUpBeforeClass() throws Exception {
		hq = new HQ("O Jabuti", 25.0, 29.90, "Teste de Observação", Estado.NOVO, Status.NACOLECAO, 10, "Floresta", "Quelonios");
		hq.setCodigo(12345);
	}
	...
	public void testToString() {
		assertEquals("[codigo=12345, tipo=história em quadrinhos, titulo=O Jabuti, precoCompra=25.0, "
				+ "precoVenda=36.0, observacoes=Teste de Observação, estado=Novo, status=Em Coleção, "
				+ "quantidadeDeEmprestimos=29]", hq.toString());
	}
