...
public class Game extends Item implements Serializable {
	...
	public Game(String titulo, Double precoCompra, Double precoVenda, String observacoes, Estado estado,
			Status status, Integer quantidade, String console, Plataforma plataforma, Boolean zerado, DLC dlc) {
		super(ItemTipo.GAMES, titulo, precoCompra, precoVenda, observacoes, estado, status, quantidade);
